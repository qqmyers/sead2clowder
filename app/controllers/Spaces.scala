                ...
                spaceForm.bindFromRequest.fold(
                  ...
                  formData => {
                    ...
                    val newSpace = ProjectSpace(name = formData.name, description = formData.description,
                                                ...
                                                collectionCount = 0, datasetCount = 0, userCount = 0, metadata = List.empty, resourceTimeToLive = formData.resourceTimeToLive, isTimeToLiveEnabled = formData.isTimeToLiveEnabled)
                    // insert space
