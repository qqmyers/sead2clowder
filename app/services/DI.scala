...
class ConfigurationModule extends AbstractModule {
  protected def configure() {
    ...
    bind(classOf[SocialUserService]).to(get("service.socialUser", "services.mongodb.MongoDBSocialUserService"))
    bind(classOf[SubscriberService]).to(get("service.subscriber", "services.mongodb.MongoDBSubscriberService"))
    bind(classOf[UserAccessRightsService]).to(get("service.userAccessRights", "services.mongodb.MongoDBUserAccessRightsService"))
  }
