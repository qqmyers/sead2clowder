...
(function ($, Configuration) {
  console.log("PTM download interface for " + Configuration.id);
  ...
  $(Configuration.tab).append("<a href='" + hostAddress+ Configuration.url + "'>Download PTM file generated from imageset</a>");
